...
.hd_nav .main_nav .main_nav_link {
    ...
    height:35px;
    color:#fff;
    background-color:rgb(28, 200, 103);
    overflow:hidden
}
...
.fixed-want dd a.red{color:#7bc709;background-color:#ffecf2;border-radius:3px}
...
.search-options dd .items a:hover{color:#5e09c7}
...
.search_num span.search_btn span em{color:#09c73c}
...
.cms-box .bd a:hover span.name{color:#c7b409}
.baokuan-goods a,.baokuan-goods a span{display:block}
.baokuan-goods a span.price{color:#09c7c1}
